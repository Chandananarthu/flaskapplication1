...
def log_table_data():
    try:
        ...
        app.logger.info("Current state of Students table:\n" + table_data)
        
    except MySQLdb.Error as e:
        app.logger.error(f'Error fetching table data: {str(e)}')
    ...
    def post(self):
        if request.is_json:
            ...
            try:
                ...
                log_table_data()  # Log the table data after insertion
    ...
    def put(self):
        if request.is_json:
            ...
            try:
                ...
                log_table_data()  # Log the table data after update
    ...
    def delete(self):
        if request.is_json:
            ...
            try:
                ...
                log_table_data()  # Log the table data after deletion
